...
RUN apt-get install -y wget curl git make gcc ccache build-essential clang libgflags-dev nlohmann-json3-dev libfmt-dev libboost-system-dev libluajit-5.1-dev libpqxx-dev librabbitmq-dev
